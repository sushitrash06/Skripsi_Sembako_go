       ...
       >
             ...
             <Grid container justify="center" spacing={spacing}>
                ...
                <img className={classes.img} alt="penjual" src={gambarpenjual}></img>
                    <Button>Login sebagai Penjual</Button>
                </Paper>
            </Grid>
            </Grid>
            <Grid item xs={3}>
            <Grid container justify="center" spacing={spacing}>
                <Paper className={classes.paper}>
                    <img className={classes.img2} alt="pemebeli" src={gambarpembeli}></img>
                        <Button justify="center">Login sebagai pemebeli</Button>
                </Paper>
                </Grid>
            </Grid>
        </Grid>
       ...
       >
             ...
             <Grid container justify="center" spacing={spacing}>
                ...
                <img className={classes.imgPedagang} alt="penjual" src={gambarpenjual}></img>
                    <Button justify="center">Login sebagai Penjual</Button>
                </Paper>
            </Grid>
            </Grid>
            <Grid item xs={12}>
            <Grid container justify="center" spacing={spacing}>
                <Paper className={classes.paper2}>
                    <img className={classes.imgPembeli} alt="pemebeli" src={gambarpembeli}></img>
                        <Button className={classes.Button}>Login sebagai pemebeli</Button>
                </Paper>
                </Grid>
            </Grid>
        </Grid>
